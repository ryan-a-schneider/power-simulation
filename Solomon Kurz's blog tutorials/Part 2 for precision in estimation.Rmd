...
pacman::p_load(tidyverse,brms,broom,report,parameters,bayestestR, rstanarm)

```

### Bayesian power analysis, Part 1 recap

This is how we simulated data for a power analysis to *detect an effect for null testing* in Part 1.
...
#Estimating an effect with a minimum degree of precision.
